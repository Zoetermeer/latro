...
action_6 (30) = happyShift action_15
...
action_12 (32) = happyShift action_7
...
action_27 (32) = happyShift action_7
...
happyReduction_12 ((HappyAbsSyn12  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn11
		 (ModuleLevelDecType $ TypeDecTy happy_var_2 happy_var_4
	) `HappyStk` happyRest
...
happyReduction_14 (HappyTerminal (TokenId happy_var_3))
	_
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenImport -> cont 14;
	TokenType -> cont 15;
	TokenInterface -> cont 16;
	TokenFun -> cont 17;
	TokenImp -> cont 18;
	TokenTest -> cont 19;
	TokenAssign -> cont 20;
	TokenLBracket -> cont 21;
	...
	TokenPlus -> cont 26;
	TokenMinus -> cont 27;
	TokenExclamation -> cont 28;
	TokenSemi -> cont 29;
	TokenDot -> cont 30;
	TokenEq -> cont 31;
	TokenId happy_dollar_dollar -> cont 32;
	_ -> happyError' (tk:tks)
	}
